...
<body><center>
	<h1>거래처 현황</h1>
<form name="corpSearchForm" method="post" action="/group4erp/viewCorpInfo.do">
...
<table class="corpListTable tbcss1" name="corpListTable" cellpadding="5" cellspacing="5" width="900">
	<tr>
