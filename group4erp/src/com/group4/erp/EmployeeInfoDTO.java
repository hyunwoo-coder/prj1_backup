...
public class EmployeeInfoDTO {
	...
	public String getIs_on_leave() {
		return is_on_leave;
	}
	public void setIs_on_leave(String is_on_leave) {
	...
	public String getMgr_emp_jikup() {
		return mgr_emp_jikup;
	}
	public void setMgr_emp_jikup(String mgr_emp_jikup) {
		this.mgr_emp_jikup = mgr_emp_jikup;
	}
	public String getMgr_emp_dep_name() {
		return mgr_emp_dep_name;
	}
